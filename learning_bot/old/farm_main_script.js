...
function editKey(e){
	if((e.keyCode <= 37 && e.keyCode >=40) || (e.keyCode <= 48 && e.keyCode >= 90)){
		...
		if(e.keyCode == 37){keyToChar = "Ã¢â€ Â";}
		if(e.keyCode == 38){keyToChar = "Ã¢â€ â€˜";}
		if(e.keyCode == 39){keyToChar = "Ã¢â€ â€™";}
		if(e.keyCode == 40){keyToChar = "Ã¢â€ â€œ";}
...
function addLanguages() {
	...
	//$('#language').append("<option value='pt'>PortuguÃƒÂªs</option>");
	//$('#language').append("<option value='cs'>Ã„Å’eÃ…Â¡tina</option>");
	//$('#language').append("<option value='ko'>Ã­â€¢Å“ÃªÂµÂ­Ã¬â€“Â´</option>");
	//$('#language').append("<option value='ro'>Ã Ã‘Æ’Ã‘ÂÃ‘ÂÃÂºÃÂ¸ÃÂ¹</option>");
	$('#language').append("<option value='el'>ÃŽâ€¢ÃŽÂ»ÃŽÂ»ÃŽÂ·ÃŽÂ½ÃŽÂ¹ÃŽÂºÃŽÂ¬</option>");
	//$('#language').append("<option value='no'>Norsk</option>");
	//$('#language').append("<option value='sk'>SlovenÃ„Âina</option>");
	...
	//$('#language').append("<option value='tr'>TÃƒÂ¼rkÃƒÂ§e</option>");
	//$('#language').append("<option value='fr'>FranÃƒÂ§ais</option>");
	$('#language').append("<option value='es'>EspaÃƒÂ±ol</option>");
	//$('#language').append("<option value='fi'>finnish</option>");
	$('#language').append("<option value='ar'>Ã˜Â§Ã™â€žÃ™â€žÃ˜ÂºÃ˜Â© Ã˜Â§Ã™â€žÃ˜Â¹Ã˜Â±Ã˜Â¨Ã™Å Ã˜Â©</option>");
	//$('#language').append("<option value='sl'>SlovenÃ…Â¡Ã„Âina</option>");
	//$('#language').append("<option value='lt'>LietuviÃ…Â³</option>");
	//$('#language').append("<option value='hr'>Hrvatski</option>");
	//$('#language').append("<option value='id'>Bahasa Indonesia</option>");
	//$('#language').append("<option value='th'>Ã Â¸ Ã Â¸Â²Ã Â¸Â©Ã Â¸Â²Ã Â¹â€žÃ Â¸â€”Ã Â¸Â¢</option>");
}
